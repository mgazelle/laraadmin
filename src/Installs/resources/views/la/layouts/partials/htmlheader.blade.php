<head>
    <meta charset="UTF-8">
    <title>@hasSection('htmlheader_title')@yield('htmlheader_title') - @endif{{ LAConfigs::getByKey('sitename_part1') . ' ' . LAConfigs::getByKey('sitename_part2') . ' ' . LAConfigs::getByKey('site_version') }}</title>
